...
def load_and_transform_vision_data2(image):
    data_transform = transforms.Compose(
        [
            transforms.Resize(
                224, interpolation=transforms.InterpolationMode.BICUBIC
...
def load_and_transform_vision_data_seconde(image):
    data_transform =  transforms.CenterCrop(224)
...
def load_and_transform_thermal_data_seconde(image):
    data_transform =  transforms.CenterCrop(224)
...
def load_and_transform_thermal_data2(thermal):
