...
def get_args_parser():
    ...
    # training parameters
    parser.add_argument('--output_dir', default='./results5',
    ...
    parser.add_argument('--pretrain_model_path', default='./resume/checkpoint0033_4scale.pth',
...
def main(args):
    ...
    if args.eval:
        ...
        test_stats, coco_evaluator = evaluate_video(model, criterion, postprocessors,
